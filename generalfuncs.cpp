...
static ll n,m,q,a[100005],b[100005],dpa[100005][64],dpb[100005][64];
    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,q)
        {
            ...
            REP(j,0,64)
            {
                ans+=__builtin_popcountll((dpa[r1][j]^dpa[l1-1][j])^(dpb[r2][j]^dpb[l2-1][j]));
            }
            cout<<ans<<'\n';
        }
